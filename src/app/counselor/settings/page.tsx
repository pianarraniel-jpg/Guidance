      ...
      <DashboardLayout>
        <div className="p-8 max-w-4xl mx-auto w-full">
          <header className="mb-8">
            ...
            <p className="text-muted-foreground">Manage your professional profile and availability preferences.</p>
          </header>
          ...
          <div className="space-y-6">
            <Card className="border-none shadow-sm overflow-hidden">
              ...
              <CardContent className="pt-6">
                 <p className="text-sm text-muted-foreground">Counseling Staff Member • University of Southern Philippines Foundation</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-sm">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-xl border border-slate-100 hover:bg-slate-50 transition-colors cursor-pointer group">
                  ...
                  <Button variant="ghost" size="sm" className="font-bold text-primary">Update</Button>
                </div>
              </CardContent>
            </Card>
