...
export default function CounselorAssessmentsPage() {
  ...
  // Derived mock data for the selected student profile (since full user records aren't all in one place)
  const studentProfile = {
    name: selectedAssessment?.studentName || "Student",
    year: "University Student",
    totalSessions: 0,
    attendance: "N/A",
    priority: selectedAssessment?.stressLevel > 75 ? "High" : "Normal",
    nextGoal: "Complete scheduled wellness session."
  };
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <Card className="border-none shadow-xl shadow-slate-200/50 bg-white rounded-[2rem] overflow-hidden">
            <CardContent className="p-8 flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-black text-slate-900 mb-1">{studentProfile.name}</h2>
              <p className="text-sm font-bold text-slate-400 mb-8">{studentProfile.year}</p>
              ...
              <div className="w-full space-y-3 mb-10">
                <div className="flex items-center justify-between p-4 rounded-2xl bg-blue-50/50 border border-blue-50">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold text-slate-600">Priority Level</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-2xl bg-emerald-50/50 border border-emerald-50">
                  ...
                  <span className="text-sm font-black text-slate-900">AI Analyzed</span>
                </div>
              </div>

              <div className="w-full text-left">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3">Assessment Context</p>
                <div className="p-5 rounded-2xl bg-primary/5 border border-primary/10 italic text-sm font-medium text-primary leading-relaxed">
                  "System-generated insights based on recent automated Kamustahan session."
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <Card className="border-none shadow-xl shadow-slate-200/50 bg-white rounded-[2rem] overflow-hidden">
            <CardHeader className="px-8 pt-8 pb-4 flex flex-row items-center justify-between border-none">
              <CardTitle className="text-sm font-black text-slate-400 uppercase tracking-widest">Real-Time Assessment Data</CardTitle>
          ...
          <Card className="border-none shadow-xl shadow-slate-200/50 bg-white rounded-[2rem] overflow-hidden">
            ...
            <CardContent className="p-8 pt-2">
               <div className="p-6 rounded-[2rem] border-2 border-dashed border-slate-100 flex flex-col items-center justify-center text-center">
                  <Brain className="h-8 w-8 text-primary/40 mb-3" />
                  <p className="text-xs font-bold text-slate-400 max-w-sm">
                    AI models indicate a synchronization of stress factors across student demographics. 
                    Review the student's personal summary above for tailored clinical interventions.
                  </p>
               </div>
            </CardContent>
          </Card>
