      ...
      <div className="mt-8 p-6 bg-slate-900 text-slate-100 rounded-3xl border border-slate-800 shadow-2xl font-mono text-xs space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-slate-800">
          <div>
            ...
            <p><span className="text-slate-400 font-bold">Role:</span> {counselor?.role || 'Guest'}</p>
          </div>
          <div>
            <p><span className="text-slate-400 font-bold">My User ID:</span> {counselor?.id || 'Not logged in'}</p>
            <p><span className="text-slate-400 font-bold">Email:</span> {counselor?.email || 'N/A'}</p>
