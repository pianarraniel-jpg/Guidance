...
Thirty-nine visual types. Semantic patterns describe behavior independently; type references describe layout. Details load only when selected.

## Canonical Design References

The **canonical design-reference source** for this skill is the upstream `diagram-design` repository maintained by Cathryn Lavery:

https://github.com/cathrynlavery/diagram-design/tree/main/skills/diagram-design/references

Reference documents must be read from the upstream repository when they are needed for a diagram. Use the corresponding raw GitHub file URL:

`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/<reference-file>.md`

Do not recreate, paraphrase, or silently substitute the upstream reference when the requested design decision depends on it. Treat the repository's current reference files as the source of truth for visual-type rules, semantic patterns, typography, connectors, animation, importing, onboarding, profiles, and export behavior. The local links in this skill are illustrative paths; when resolving a reference, prefer the canonical upstream URL above.
...
First check the project root for a `.diagram-design` marker and resolve it per [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/profiles.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/profiles.md). A valid marker whose profile exists selects that file directly and skips this gate; `profile: default` also skips it. A malformed or missing-profile marker follows the visible failure handling in that reference. Never copy a marker-selected profile over the installed working copy.

Open [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/style-guide.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/style-guide.md) and check the default tokens. If they're still the shipped defaults (paper `#f5f5f5`, ink `#2d3142`, accent `#eb6c36` atomic-tangerine), **pause and ask the user**:
...
Then branch per the matching section of [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/onboarding.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/onboarding.md); for **(f)** follow [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/profiles.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/profiles.md).
...
When behavior, state, enforcement, or risk carries the meaning, first load [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/semantic-patterns.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/semantic-patterns.md) and choose one primary pattern. Then choose the nearest visual type for layout. If no pattern matches, choose the type directly.
...
The pattern owns semantic primitives and its tighter budget; the type owns layout grammar. Use [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/animation.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/animation.md) only when motion is requested or materially clarifies ordered change; static remains the default.

### Visual-type guide (39)

| If you're showing… | Use | Reference |
|---|---|---|
| Components + connections in a system | **Architecture** | [type-architecture.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-architecture.md) |
| Legacy IT landscape grouped by phase/department; documents the *before* state in modernization proposals | **IT current-state** | [type-it-state.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-it-state.md) |
| Decision logic with branches | **Flowchart** | [type-flowchart.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-flowchart.md) |
| Time-ordered messages between actors | **Sequence** | [type-sequence.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-sequence.md) |
| States + transitions + guards | **State machine** | [type-state.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-state.md) |
| Entities + fields + relationships | **ER / data model** | [type-er.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-er.md) |
| Events positioned in time | **Timeline** | [type-timeline.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-timeline.md) |
| Cross-functional process with handoffs | **Swimlane** | [type-swimlane.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-swimlane.md) |
| Two-axis positioning / prioritization | **Quadrant** | [type-quadrant.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-quadrant.md) |
| Multiple entities scored across 3–5 quantitative criteria | **Radar / Spider** | [type-radar.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-radar.md) |
| One quantitative series across cyclic categories; angle=category, radius=magnitude | **Polar chart** | [type-polar.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-polar.md) |
| Reinforcing cycle / flywheel where the last step feeds the first and a shared hub accumulates state | **Loop** | [type-loop.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-loop.md) |
| Hierarchy through containment / scope | **Nested** | [type-nested.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-nested.md) |
| Parent → children relationships | **Tree** | [type-tree.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-tree.md) |
| Human/agent/team ownership, reporting, routing, escalation | **Org chart** | [type-org-chart.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-org-chart.md) |
| Stacked abstraction levels | **Layer stack** | [type-layers.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-layers.md) |
| Overlap between sets | **Venn** | [type-venn.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-venn.md) |
| Ranked hierarchy or conversion drop-off | **Pyramid / funnel** | [type-pyramid.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-pyramid.md) |
| Quantitative comparison across categories | **Bar chart** | [type-bar.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-bar.md) |
| Part-of-whole where the relative sizes are the story | **Treemap** | [type-treemap.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-treemap.md) |
| Continuous trends over time, change between exactly two states (slopegraph), one distribution per series (ridgeline), or rank movement across several snapshots (bump) | **Line chart** | [type-line.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-line.md) |
| Tasks and phases on a timeline | **Gantt** | [type-gantt.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-gantt.md) |
| Distribution and correlation between two variables, three with area-sized marks (bubble), or one variable with a dot per item (beeswarm) | **Scatter plot** | [type-scatter.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-scatter.md) |
| End-to-end data stack on a container cluster | **High-Level** | [type-high-level.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-high-level.md) |
| Multi-actor sequential process with data handoffs | **Process** | [type-process.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-process.md) |
| Multi-tier data storage with quality levels and access policies | **Medallion** | [type-medallion.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-medallion.md) |
| Role-scoped data flow: who does what at each pipeline step | **Data flow** | [type-data-flow.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-data-flow.md) |
| Integration topology of a data platform — sources → core → consumers | **DP integration** | [type-dp-integration.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-dp-integration.md) |
| Per-role / per-component access permissions matrix | **DP security matrix** | [type-dp-security-matrix.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-dp-security-matrix.md) |
| A quantity splitting and merging across stages, band width = amount | **Sankey** | [type-sankey.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-sankey.md) |
| Causes of one observed effect, grouped by category (root-cause analysis) | **Fishbone** | [type-fishbone.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-fishbone.md) |
| Value chain against evolution — what to build, buy, and what is moving | **Wardley map** | [type-wardley.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-wardley.md) |
| Work-in-progress by state, with WIP limits and blocked items | **Kanban** | [type-kanban.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-kanban.md) |
| What a person does across stages of an experience, and how it feels | **User journey** | [type-journey.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-journey.md) |
| Where software runs — zones, hosts, artifacts, replicas, ports | **Deployment** | [type-deployment.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-deployment.md) |
| What depends on what, with fan-in and cycles a tree cannot express | **Dependency graph** | [type-dependency.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-dependency.md) |
| Classes with operations, inheritance, composition (other UML routes elsewhere) | **UML class** | [type-uml-class.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-uml-class.md) |
| Narrative backbone sliced into releases, with the cut line | **Story map** | [type-story-map.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-story-map.md) |
| Physical tables: SQL types, constraints, indexes, column-level FKs | **Database schema** | [type-db-schema.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-db-schema.md) |
...
**The design system is skinnable.** All colors, typography, and tokens live in a single source of truth — [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/style-guide.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/style-guide.md). This file describes semantic roles (`paper`, `ink`, `muted`, `accent`, `link`, …). The default skin is a cool editorial palette (white-smoke paper, jet-black ink, atomic-tangerine accent, blue-slate muted, silver hairlines); to apply your own brand, either edit `style-guide.md` directly or run the URL-based flow described in [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/onboarding.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/onboarding.md).
...
**CJK labels** — Geist and Instrument Serif carry no Hangul or Han; extend the family and keep CJK at 12px+. Rules: [Korean](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/style-guide.md#korean-labels), [Chinese](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/style-guide.md#traditional-chinese-labels).
...
- Editorial callouts → [primitive-annotation.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/primitive-annotation.md)
- Hand-drawn variant → [primitive-sketchy.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/primitive-sketchy.md)
- Icon set (laptop, server, DB, K8s, Docker, AWS, …) → [primitive-icons.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/primitive-icons.md). Browse the gallery at [`assets/icons.html`](assets/icons.html).
- Terminal / CLI-window variant → [primitive-terminal.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/primitive-terminal.md)
- Optional explanatory motion → [animation.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/animation.md)
...
3. **No overlapping connectors.** Two connectors must never share the same stroke path, run parallel on top of each other, or be drawn on top of each other for any segment. When two orthogonal arrows must cross at a single point, apply the **bridge / hop** primitive (see `https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-architecture.md` § Crossing arrows). When two arrows naturally want to overlap, offset their routing by ≥12px so each line is independently traceable. If you find yourself stacking connectors, redesign the layout — it means two nodes are too close, or the diagram is over budget (split into overview + detail).
...
| Max motion (optional) | 8 steps, 12 marked items, 2 simultaneous items — see [animation.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/animation.md) |
...
- [ ] If this is an import — format, size, detail level, and audience set? `viewBox` and type ramp match the size preset? (§11, [output-spec.md §6](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/output-spec.md))
...
- [ ] Annotation callouts (if any) in *italic* Instrument Serif? (see [primitive-annotation.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/primitive-annotation.md))
...
| **Consultant special** (quadrant only) | `example-quadrant-consultant.html` | BCG/McKinsey-style 2×2 scenario matrix. Clinical sans-serif, white bg, bold blue double-ended axes, named scenario cells. See [type-quadrant.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/type-quadrant.md#consultant-special-2x2-scenario-matrix). |

**Sketchy variant** (optional, applied to any of the above) — see [primitive-sketchy.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/primitive-sketchy.md). SVG turbulence filter wobbles strokes for a hand-drawn feel. Good for essays, not for technical docs.

**Terminal variant** (optional, replaces any of the above) — see [primitive-terminal.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/primitive-terminal.md). Start from `assets/template-terminal.html`; terminal examples use the `example-<type>-terminal.html` naming pattern. Charcoal CLI-window chrome, monospace, one red-orange accent. Good for dev-tool posts; not brand-tokenized, so skip it for onboarded output.

**Animation** (optional presentation layer) — see [animation.md](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/animation.md). Modes are `none` (default), `reveal`, `step`, and `loop`; motion never changes the static meaning or raises the complexity budget.
...
Route by source: `.drawio*` → [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/import-drawio.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/import-drawio.md); `.mmd`, `.mermaid`, or Markdown containing a fenced `mermaid` block → [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/import-mermaid.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/import-mermaid.md). Follow the selected reference for "convert this", "redraw this diagram", "make this presentable", and the corresponding import command.
...
Every imported diagram is shaped by four decisions, set **before** drawing — full spec in [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/output-spec.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/output-spec.md).
...
When the user asks to export, save, rasterize, or convert a generated diagram to `.png` or `.svg`, load [`https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/export.md`](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/export.md) and follow the procedure there. Both formats deliver the diagram only (the `<svg>` node) — editorial wrappers like cards and headers are dropped by design. Export is **manual** — never produce export files unprompted.

For an imported diagram, pixel dimensions come from the `viewBox` × scale factor, so its size decision belongs to §11, not to export. For any diagram that needs an exact frame (an OG card or a 1920×1080 slide image), see [`export.md` § Sizing the export](https://raw.githubusercontent.com/cathrynlavery/diagram-design/main/skills/diagram-design/references/export.md).
